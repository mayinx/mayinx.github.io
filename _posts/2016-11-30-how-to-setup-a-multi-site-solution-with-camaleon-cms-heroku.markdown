...
Now it's finally time to test your Heroku App by creating a couple of Sites with Camaleon CMS - suppose you want to set up Sites for your immaginary clients "ACME Corporation" and "FUBAR Inc.":
...
You can be sure that you set everything up correctly if you can access the ACME Corporation's Site via http://acme.yourdomain.com/, the FUBAR Inc.'s Site via ' http://acme.yourdomain.com/, and your main / defualt-site via http://www.yourdomain.com/ and http://yourdomain.com/. If that's the case: Congrats - you got a working Multisite-solution with just a single CMS-Installation, that costs you nothing (apart from the fees for domain-registration & services).   
...
- .... [check for detials on user rolls]
